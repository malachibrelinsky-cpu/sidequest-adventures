    ...
    <header className="sticky top-0 z-50 backdrop-blur-xl bg-background/60 border-b border-border">
      <div className="mx-auto max-w-7xl px-6 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-muted-foreground">
          <Link to="/quests" activeProps={{ className: "text-primary" }} className="hover:text-foreground transition">Sidequests</Link>
          ...
          <Link to="/settings" activeProps={{ className: "text-primary" }} className="hover:text-foreground transition">Settings</Link>
